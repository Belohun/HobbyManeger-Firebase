package com.example.firebase.ui.Books
...
class BooksFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val context: Context = requireActivity().baseContext
        val currentFragment = "Books"
        ...
        val recyclerview:RecyclerView = root.findViewById(R.id.rv_books)
